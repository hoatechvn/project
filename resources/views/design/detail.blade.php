...
<div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-sm-4" style="background-color:#fff; font-weight:bold;padding: 10px 0 10px 20px;font-size: 14px;">ID hợp đồng
        </div>
        <div class="col-sm-8" style="background-color:#fff;padding: 10px 0 10px 20px;font-size: 14px;">{{$design->id}} 
        </div>
        <div class="col-sm-4" style="background-color:#F8F8F8; font-weight:bold;padding: 10px 0 10px 20px;font-size: 14px;">Tên hợp đồng
        </div>
        <div class="col-sm-8" style="background-color:#F8F8F8;padding: 10px 0 10px 20px;font-size: 14px;">{{$design->name}} 
        </div>
        ...
        <div class="col-sm-12" style="background-color:#f0ad4e; font-weight:bold;padding: 10px 0 10px 20px;font-size: 14px;">
        <h3> Thông tin chi tiết</h3></div>  
        ...
        <div class="col-sm-8" style="background-color:#fff;padding: 10px 0 10px 20px;font-size: 14px;">{{$design->ward}} 
        </div>
        ...
        <div class="col-sm-8" style="background-color:#F8F8F8;padding: 10px 0 10px 20px;font-size: 14px;">{{$design->min_cost}} </div>
        ...
        <div class="col-sm-8" style="background-color:#fff;padding: 10px 0 10px 20px;font-size: 14px;">{{$design->received_cost}} </div>
        ...
        <div class="col-sm-8" style="background-color:#F8F8F8;padding: 10px 0 10px 20px;font-size: 14px;">{{$design->time}} </div>
        </div>     
        <!-- /.row -->
