            ...
            <form id="form1" action="design/add" method="POST">
                ...
                <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="cus_phone" value="{{$design->phone}}" placeholder="Nhập số điện thoại" onkeydown="return ( event.ctrlKey || event.altKey 
                    ...
                    <div class="form-group">
                        <label> Email </label>
                        <input class="form-control" name="cus_mail" value="{{$design->email}}" placeholder="Nhập email" type="email"/>
                    </div>
                    <div class="form-group">
