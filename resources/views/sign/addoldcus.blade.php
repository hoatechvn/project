...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Tạo hợp đồng lấy dấu cho khách hàng
            ...
            <form action="sign/add" method="POST">
                ...
                <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="customer"  value="{{$customer->name}}" />
                    </div>
                    
                    <div class="form-group">
                        <label> Số điện thoại</label>
                        <input  class="form-control" name="phone" value="{{$customer->phone}}" onkeydown="return ( event.ctrlKey || event.altKey 
