...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        @endif
            <form action="bill/receiptsservice/{{$service->id}}" method="POST">
            <input type="hidden" name="_token" value="{{csrf_token()}}"/>
              
                <div class="form-group">
                    <label>Họ và tên người nộp tiền <font style="color: red;">*</font></label>
                    <input class="form-control" name="customer" value="{{$service->customer}}" placeholder="Nhập họ và tên người nộp tiền" />
                </div>
                <div class="form-group">
                    <label>Địa chỉ <font style="color: red;">*</font></label>
                    <input class="form-control" name="cus_address" value="{{$service->cus_address}}" placeholder="Nhập địa chỉ" />
                </div>
                <div class="form-group">
