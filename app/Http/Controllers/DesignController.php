...
class DesignController extends Controller {
	...
	public function getUpdate($id){
		...
		$service = service::all();
		$typecontract=type_contract::all();
		return view('design.update',['design' => $design, 'account' => $account, 'typecontract' => $typecontract, 'service' => $service]);
	}
	...
	public function postUpdateprint(Request $request, $id){
		...
		$this->validate($request, 
		 ...
		 return view('contracttemplate.contractdesign',['design' =>$design,'cost' =>$cost,'typecontract' => $typecontract, 'service' => $service]);
	}
